...
好吧, 我承认，前面都是在胡说八道，实际上贝塞尔曲线的运用是十分广泛的，在你不经意间就已经使用过它了。

如果你会使用Photoshop的话，你可能会注意到里面有一个钢笔工具。是一个令人十分费解的东东，我在一开始尝试使用的时候总会制造出一些和我预期不同的曲线，各种歪歪扭扭，实际上这个钢笔工具运用的就是贝塞尔曲线。
